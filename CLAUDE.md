...
- `docs/EPICS.md` — the work plan: Phase 1 (live — GitHub milestones M1/M2/M3, issue #n = epic En, the France-ready cut line) and Phase 2 (planned — M4–M6, provisional codes E26–E43, gated on the E19 exit-criteria read; issues not yet created). Pick work from here; specs stay authoritative for *how*.
