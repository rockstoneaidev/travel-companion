...
- `docs/EPICS.md` — the work plan: Phase 1 (M1–M3) and Phase 2 (M4–M6, epics E28–E45 on GitHub, **work gated on the E19 exit-criteria read** post France trip). GitHub milestones, epic index (issue #n = epic En), dependency spines, cut lines. Pick work from here; specs stay authoritative for *how*.
