...
- `docs/DPIA.md` — the Art. 35 impact assessment (DRAFT). Read §3.2 before touching the taste profile: the learned `spiritual` / `religious_sacred` weights are arguably Art. 9 data by inference, and explicit consent is an unresolved pre-launch blocker.
