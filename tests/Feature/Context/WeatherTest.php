...
it('calls once per tile and serves everyone else from the cache', function () {
    ...
    $client->forTile('8808866111fffff', 59.31, 18.02);
    $client->forTile('8808866111fffff', 59.31, 18.02);
    $weather = $client->forTile('8808866111fffff', 59.31, 18.02);
...
it('degrades to "unknown" when the sky is unreachable — it does not fail the feed', function () {
    ...
    $weather = app(WeatherClient::class)->forTile('8808866111fffff', 59.31, 18.02);
...
it('stops asking a source that keeps failing', function () {
    ...
    foreach (range(1, 8) as $i) {
        $client->forTile("880886611{$i}fffff", 59.31, 18.02);
    }
...
it('caches the tile, not the user', function () {
    ...
    app(WeatherClient::class)->forTile('8808866111fffff', 59.31, 18.02);
