...
/** Where a position came from (ADMIN §6). `emulated` is never learned from. */
export const CONTEXT_SOURCES = ['device', 'emulated'] as const;
...
export const FEEDBACK_EVENTS = ['accepted', 'saved', 'dismissed', 'visited', 'ignored', 'visit_prompt_declined', 'unsaved', 'undismissed'] as const;
